  ...
  function buildAuthOverlay() {
    ...
    overlay.innerHTML = `
      <div class="login-box" role="dialog" aria-modal="true" aria-labelledby="login-title">
        <img class="login-logo-img" src="${window.MG?.Utils?.pathPrefix ? MG.Utils.pathPrefix() : '../'}assets/images/branding/logo-nav.webp"
             alt="MelaninGold Organic" width="216" height="144" loading="eager">
  ...
  function injectAuthStyles() {
    ...
    style.textContent = `
      ...
      .login-logo-img {
        ...
        height: auto;
        margin: 0 auto 20px;
        filter: brightness(1.14) drop-shadow(0 0 9px rgba(201,148,58,0.28));
      }
      .login-kicker {
        margin-bottom: 16px;
        color: #C9943A;
